...
export const fixtureActor = {
  ...
  auditor: (): ActorContext => ({
    actorId: 'actor_audit',
    roleIds: ['auditor'],
    permissionPoints: ['audit_log:view', 'raw_evidence:view'],
  ...
  killSwitchOperator: (): ActorContext => ({
    actorId: 'actor_killswitch',
    roleIds: ['kill-switch-operator'],
    permissionPoints: ['kill_switch:operate', 'audit_log:view'],
    assetGroupIds: ['ag_corp_internal', 'ag_corp_public'],
    yoloEnabled: false,
  }),
};
